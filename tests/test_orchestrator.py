...
class TestRemediationOrchestrator:
    def test_retries_same_unit_until_validation_clears_it(self, tmp_path: Path):
        _write_package_json(
    ...
    def test_falls_back_to_single_unit_deterministic_fix(self, tmp_path: Path):
        _write_package_json(
            tmp_path / "package.json",
            '{\n  "name": "my-project",\n  "dependencies": {\n    "lodash": "^4.17.15"\n  }\n}\n',
        )
        ...
        with patch(
            ...
            "viper.orchestrator.DirectFixer.fix_action",
